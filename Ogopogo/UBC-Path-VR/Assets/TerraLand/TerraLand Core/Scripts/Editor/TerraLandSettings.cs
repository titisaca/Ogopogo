...
public class TerraLandSettings : EditorWindow
{
    ...
    private static Vector2 windowSize = new Vector2(540, 480);
    ...
    private static Rect statusRect;
    private static string buttonTitle;
    private static string welcomePageLink = "https://terraunity.com/terraland_welcome_page/";
...
//        GUILayout.EndHorizontal();
        ...
        if (statusStr.Equals("Everything Is Ok"))
        {
            ...
            GUILayout.BeginHorizontal();
            GUILayout.FlexibleSpace();
            EditorGUILayout.HelpBox("Restart Unity to complete installation!", MessageType.Warning);
            GUILayout.FlexibleSpace();
            GUILayout.EndHorizontal();
        }
        ...
        statusRect = GUILayoutUtility.GetLastRect();
        statusRect.x = (GUILayoutUtility.GetLastRect().width / 2f) - 100;
        statusRect.y += 60;
        statusRect.width = 200;
        statusRect.height = 25;
    ...
    {
        Help.BrowseURL(welcomePageLink);
    }
