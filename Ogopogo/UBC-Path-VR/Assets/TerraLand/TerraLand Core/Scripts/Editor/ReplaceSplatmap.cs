...
public class ReplaceSplatmap : ScriptableWizard
{
    ...
    //[MenuItem("Tools/TerraUnity/Common/Replace Terrain Splatmap", false, 0)]
    static void Replace ()
    {
        TFeedback.FeedbackEvent(EventCategory.UX, EventAction.Click, "Replace_Terrain_Splatmap");
        DisplayWizard<ReplaceSplatmap> ("ReplaceSplatmap", "Replace");
    }
    ...
    void OnWizardCreate ()
    {
        ...
        try
        {
            ...
            Splatmap.Reinitialize(New.width, New.height, New.format, true);
