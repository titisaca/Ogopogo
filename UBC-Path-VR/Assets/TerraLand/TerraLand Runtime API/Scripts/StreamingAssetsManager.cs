...
public class StreamingAssetsManager : MonoBehaviour
{
    ...
    private void CreateBackgroundMountain()
    {
        ...
        //android Build
        if (runtimeOffline.androidBuild)
        {
            globalHeightmapPath = Application.persistentDataPath + "/" + "GlobalHeightmap.tif";
            globalSatelliteImagePath = Application.persistentDataPath + "/" + "GlobalSatelliteImage.jpg";
        }
        //android Build
    ...
    private void CreateBackgroundMountain2()
    {
        ...
        if (runtimeOffline.androidBuild)
        {
            globalHeightmapPath = Application.persistentDataPath + "/" + "GlobalHeightmap2.tif";
            globalSatelliteImagePath = Application.persistentDataPath + "/" + "GlobalSatelliteImage2.jpg";
        }
        //android Build
        ...
        if (useLayer && prefabsCount > 0)
        {
            ...
            foreach (Terrain t in tiles)
            {
                ...
                if (checkMapColors && runtimeOffline.imageryAvailable && !runtimeOffline.elevationOnly)
                {
                    ...
                    if (processCounterDone == 0)
                    {
                        string satelliteImageName = data.terrainLayers[0].diffuseTexture.name;
